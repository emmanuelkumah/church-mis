...
const InputControl: React.FC<InputControlProps> = ({
  ...
  let inputClasses = `h-11 w-full border shadow-theme-xs border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${className}`;
  if (disabled) {
